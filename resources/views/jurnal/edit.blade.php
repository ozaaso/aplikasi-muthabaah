...
<div class="checkbox-grid">
    ...
    <div>
        ...
        <label><input type="checkbox" name="tarawih" value="1" {{ $aktivitas->tarawih == 1 ? 'checked' : '' }}> Tarawih</label>
        <label><input type="checkbox" name="witir" value="1" {{ $aktivitas->witir == 1 ? 'checked' : '' }}> Witir</label>
